...
public class MessageService {
	...
	public MessageService(){
		messages.put(1L, new Message(1, "Hello World", "Mustafa", "http://localhost:8080/messenger/webapi/messages/1"));
		messages.put(2L, new Message(2, "Hello World Again", "Mustafa", "http://localhost:8080/messenger/webapi/messages/2"));
	...
	public Message addMessage(Message message){
		...
		message.setUri("http://localhost:8080/messenger/webapi/messages/"+message.getId());
